...
?>
    ...
    <div class="container">
      <form id="portal" method="post" action="/portals/add">
        <h4><?= _("portal_info")?></h4>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input id="api_login" type="text" name="api_login" class="form-control">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input id="api_pass" type="text" name="api_pass" class="form-control">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input id="api_url" type="text" name="api_url" class="form-control">
          </div>
        </div>
